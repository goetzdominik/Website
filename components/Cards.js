...
// // const Card = ({ href, imgSrc, imgAlt, title, description, badgeLeft, aiTag, badgeBottomLeft }) => (
// //     <Link className="card" href={href}>
// //         <Image isZoomed src={imgSrc} fallbackSrc="/img/Placeholder/filler_2.png" alt={imgAlt} placeholder='blur' fill={true} />
// //         <div className="m-4">
// //             <span className="font-bold">{title}</span>
// //             <span className="block text-secondary dark:text-gray-400">{description}</span>
// //         </div>
// //         {semester && <div className="badge_left"><span>{semester}</span></div>}
// //         {aiTag && <div className="badge_right"><span>{aiTag}</span></div>}
// //         {badgeBottomLeft && <div className="badge_bottom_left"><span>{badgeBottomLeft}</span></div>}
// //     </Link>
// // );
...
//                     description="All previous exercise session."
//                     aiTag="AI generated"
//                 />
//             </div>
//             <h3 className="page_title mt-6">Personal</h3>
