        ...
        <div>
            ...
            <div className="mt-8 grid grid-cols-1    sm:grid-cols-2 lg:grid-cols-4 gap-8  text-primary dark:text-gray-100" >
                    ...
                    <Link className = "card   "  href = "/Teaching/FS24">
                        <Image isZoomed src="/img/Main/ACOCII.jpg" alt="NextUI hero Image with delay"  placeholder='blur' width={540}  height={540}/>
                    ...
                    <Image isZoomed src="/img/Main/RBTL_big.jpg" placeholder='blur' alt="Presentation" width={540 }  height={540}/>
                        <div className = "m-4">
                    ...
                    <Image isZoomed src="/img/Main/rain.jpg" placeholder='blur' alt="Contact" width={540 }  height={540}/>
                        <div className = "m-4">
                    ...
                    <Image isZoomed src="/img/Main/dominik.jpg" placeholder='blur' alt="About" width={540 }  height={540}/>
                        <div className = "m-4">
