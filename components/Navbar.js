            ...
            <div className="max-w-screen-xl flex flex-wrap items-center justify-center pt-4 p-1 lg:p-4">
                ...
                <div
                    ...
                    <ul className="flex flex-col lg:flex-row items-center lg:p-0 font-medium lg:space-x-8 rtl:space-x-reverse dark:bg-gray-800 lg:dark:bg-gray-900 dark:border-gray-700">
                            ...
                            <Dropdown className="bg-white rounded-lg border border:gray-50 shadow-md">
                                ...
                                <DropdownMenu className="font-body" aria-label="Static Actions">
                                    ...
                                    <DropdownItem key="delete" >
                                        <Link href="/Library" onClick={closeMenu} className="block hover:bg-gray-300 p-1 rounded-lg  ">Libray </Link>
                                    </DropdownItem>
                                </DropdownMenu>
                            </Dropdown>
                        </li>
                        ...
                        <li>
                            <Link href="/Biolab" onClick={closeMenu} className="block py-1 px-3 text-primary   hover:text-gray-500 rounded  lg:hover:bg-transparent lg:p-0 lg:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Bio Lab</Link>
                        </li>
                        <li className="">
                            <Dropdown className="bg-white rounded-lg border border:gray-50 shadow-md">
                                <DropdownTrigger>
