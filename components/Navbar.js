...
const Navbar = () => {
    ...
    const menuItems = [
        // { href :"", label: "All Teachings" , description:"Copy the file link"
        //     , shortcut:"⌘C"},
                        ...
                        <ul className="flex flex-col lg:flex-row items-center lg:p-0 font-medium lg:space-x-8 rtl:space-x-reverse dark:bg-gray-800 lg:dark:bg-gray-900 dark:border-gray-700">
                            ...
                            <li>
                                <Dropdown className="bg-white rounded-lg border border:gray-50 p-0 shadow-md">
                                    ...
                                    <DropdownMenu className="" aria-label="Static Actions" disabledKeys={menuHeader.map(item => item.label)}>
                            ...
                            <li>
                                <Dropdown className="bg-white rounded-lg border border:gray-50 p-0 shadow-md">
                                    ...
                                    <DropdownMenu className="" aria-label="Static Actions">
                                        {renderDropdownItems(exploreItems)}
                                    </DropdownMenu>
                                </Dropdown>
                            </li>
                        </ul>
