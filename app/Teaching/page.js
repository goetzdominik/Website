...
const Teaching = () => {
    return ( 
        <div>
            ...
            <div className="mt-8 grid grid-cols-1    md:grid-cols-2 lg:grid-cols-4 lg:pl-28 lg:pr-28 pl-6 pr-6 sm:p-0 gap-8  text-primary dark:text-gray-100" >
                 <Card
                    href="/Teaching/HS25"
                    imgSrc="/img/Main/OCI.jpg"
                    imgAlt="NextUI hero Image with delay"
                    title="OC I (currently)"
            ...
            <div className="mt-8 grid grid-cols-1    md:grid-cols-2 lg:grid-cols-4 lg:pl-28 lg:pr-28 pl-6 pr-6 sm:p-0 gap-8  text-primary dark:text-gray-100" >
                <Card
                    href="/PVK/ACOCII"
                    imgSrc="/img/Main/PVK_ACOCII.JPG"
                    imgAlt="ACOCI"
                    title="ACOC I"
