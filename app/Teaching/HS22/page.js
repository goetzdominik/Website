...
const HS22 = () => {
    return ( 
        ...
        <div className=" text_card_grid">
            <div className =" md:w-1/3 text_card_icon grid-cols-[auto_100px] ">
                ...
                <div>
                    <Link href="/download/HS22/Anki.zip" className = "icon_text_card " role="button" target="_blank">
            ...
            <div className =" md:w-2/3 text_card_icon">
                <div>
                    <h2>
                    Padlett
                    </h2>
                ...
                <div>
                    <Link href="https://padlet.com/dogoetz/informatik-1-padlet-o6g8187ziqq88diz" className = "icon_text_card" role="button" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
