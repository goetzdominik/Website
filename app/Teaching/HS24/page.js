            ...
            <div className=" text_card_grid">
                ...
                <div   className="md:w-3/5 text_card" >
                    <h2>
                     ...
                     <p className="text-gray-500">
                        We are meeting every tuesday at 7:45 in HCI 2.1, please be on time. Below you will find my notes for the exercise session with tips for the series. These are in no way a substitute for the scripts or the lecture and should only be used as additional aids.
                    </p>
                </div>
