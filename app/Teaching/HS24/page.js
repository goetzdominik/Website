        ...
        <div className="">   
            ...
            <div className=" text_card_grid">
                ...
                <div className =" md:w-3/5 text_card ">
                    <h2>
                    529-0221-00L  Organische Chemie I
                    </h2>
                    <p className="text-gray-500">
                    Slides and solutions for the exercise session, accompanying the OC I lecture by Prof. Wennemers. This lecutre is for students of the D-Chab at ETH Zürich, third semester. Students are introduced to carbonyl reactions and their mechanism.
                    </p>
                </div>
                <div   className="md:w-3/5 text_card" >
                    <h2>
                     ...
                     <p className="text-gray-500">
                        We are meeting every tuesday at 7:45 in HCI H 2.1, please be on time. Below you will find my notes for the exercise session with tips for the series. These are in no way a substitute for the scripts or the lecture and should only be used as additional aids.
                    </p>
                </div>
                <div className =" md:w-2/5 text_card_icon ">
                    <div>
                        ...
                        <p className="text-gray-500">
                            ...
                            Created by Niels Steck,  with key concepts from OC I.
                        </p>
                    </div>
                    <div>
                        <Link href="/download/HS24/OCI.apkg" className = " icon_text_card " role="button" target="_blank">
                ...
                <div className="relative overflow-x-auto shadow-md rounded-lg mt-8 ">
                    <table className="w-full  text-left rtl:text-right text-secondary ">
                        ...
                        <tr className="odd:bg-white  even:bg-gray-0 border-b ">
                            ...
                            <tr className="odd:bg-white  even:bg-gray-0 border-b ">
                                <th scope="row" className="px-6 py-4 font-medium text-gray-900  ">
                                Reactivity at alpha-Carbon III
                                </th>
                                <td className="px-6 py-4 hidden md:block ">
                                17.12.2024
                                </td>
                                <td className="px-6 py-4 ">
                                    <Link href="/download/HS24/ex13.pdf" className=" text-blue-600 dark:text-blue-500 hover:underline"  target="_blank">Week 14</Link>
                                </td>
