                    ...
                    <table className="w-full  text-left rtl:text-right text-secondary ">
                        ...
                        <tbody>
                            ...
                            <tr className="odd:bg-white  even:bg-gray-0 border-b ">
                                ...
                                <Link className = "text-blue-600 hover:underline" href="/download/FS24/ACOCII_U6_menti.pdf" target="_blank">Menti 6</Link>
                            ...
                            <tr className="odd:bg-white  even:bg-gray-0 border-b ">
                                ...
                                <Link className = "text-blue-600 hover:underline" href="/download/FS24/ACOC_II_U13_menti.pdf" target="_blank">Menti 13</Link>
