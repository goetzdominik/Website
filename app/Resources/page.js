...
const resources = () => {
    return (
        ...
        Data: Analysis of Alkyne and Chloro Acyl Warhead Modified UbV D.15
Binding Affinity Towards USPs using Intein Chemistry
        </h1>
        <div className=" flex flex-col  p-4 bg-white  md:p-4 pt-8 gap-8  text-primary  lg:flex-row">
            <div className =" lg:w-1/2  poster_card  ">
            <Link className = "card  border-2 border-gray-50 "  href = "/download/Resources/UbV_Report.pdf"  role="button" target="_blank"> 
                    <Image src="/img/Resources/UbV.png"  alt="poster" fill = {true}/>
                    
                    
                    
                </Link>
            </div>
            <div className =" lg:w-1/2 text_card_icon ">
                ...
                Here you can find the report and additional data form my work on "Analysis of Alkyne and Chloro Acyl Warhead Modified UbV D.15
Binding Affinity Towards USPs using Intein Chemistry"
               
                </p>
                <Link href="/download/Rescources/UbV_LCMSMS.zip" className = "icon_text_card" role="button" target="_blank">
        ...
        <h1 className="page_subtitle" > 
        Presentation: Important Mutations for Phenotype Difference in Staphylococcus Aureus 6850 
        </h1>
        <div className=" flex flex-col  p-4 bg-white  md:p-4 pt-8 gap-8  text-primary  lg:flex-row">
            <div className =" lg:w-1/2  poster_card  ">
            <Link className = "card  border-2 border-gray-50 "  href = "/download/Presentation/Poster_1_Dominik_Gotz.pdf"  role="button" target="_blank"> 
                    <Image src="/img/Poster_1.jpg"  alt="poster" fill = {true}/>
            ...
            <div className =" lg:w-1/2 text_card_icon ">
                ...
                <Link href="/download/Presentation/Abstract Dominik Goetz.pdf" className = "icon_text_card" role="button" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 m-2 h-6">
                            <path fillRule="evenodd" d="M19.5 21a3 3 0 0 0 3-3V9a3 3 0 0 0-3-3h-5.379a.75.75 0 0 1-.53-.22L11.47 3.66A2.25 2.25 0 0 0 9.879 3H4.5a3 3 0 0 0-3 3v12a3 3 0 0 0 3 3h15Zm-6.75-10.5a.75.75 0 0 0-1.5 0v4.19l-1.72-1.72a.75.75 0 0 0-1.06 1.06l3 3a.75.75 0 0 0 1.06 0l3-3a.75.75 0 1 0-1.06-1.06l-1.72 1.72V10.5Z" clipRule="evenodd" />
                        </svg>
                    </Link >
