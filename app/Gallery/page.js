    ...
    <div className="pt-12">
      ...
      <div className="grid grid-cols-2 pt-8  lg:grid-cols-4 gap-8">
        ...
        <div className="grid gap-4">
          ...
          <div className="gallery_card">
            <Image radius="lg"  className="image_content" placeholder='blur' src="/img/Gallery/board_small.jpg" alt="2" fill={true}/>
        ...
        <div className="grid gap-4">
          {/* Column 1 */}
          <div className="gallery_card">
            <Image radius="lg"  className="image_content" placeholder='blur' src="/img/Gallery/bike_small.jpg" alt="1" fill={true}/>
          ...
          <div className="gallery_card">
            <Image radius="lg"  className="image_content" placeholder='blur' src="/img/Gallery/sunset_small.jpg" alt="2" fill={true}/>
