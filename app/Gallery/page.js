    ...
    <div className="pt-12">
      ...
      <div className="grid grid-cols-2 pt-8 p-4 lg:grid-cols-4 gap-8">
        ...
        <div className="grid gap-4">
          ...
          {/* Column 2 */}
          <div className="gallery_card">
            <Image radius="lg"  className="image_content" src="/img/Gallery/oc_lab.jpg" alt="2" fill={true}/>
            <div className="overlay_text">Had a great time in the BCB III: OC lab</div>
          </div>
          <div className="gallery_card">
            <Image radius="lg"  className="image_content" src="/img/Gallery/board_small.heic" alt="2" fill={true}/>
        ...
        <div className="grid gap-4">
          {/* Column 1 */}
          <div className="gallery_card">
            <Image radius="lg"  className="image_content " src="/img/Gallery/dominik.jpg" alt="1" fill={true}/>
            <div className="overlay_text">At Polyball 2023, Europes biggest dance ball</div>
          </div>
          {/* Column 2 */}
          <div className="gallery_card">
            <Image radius="lg"  className="image_content" src="/img/Gallery/retro_small.jpg" alt="2" fill={true}/>
          ...
          <div className="gallery_card">
            ...
            <div className="overlay_text">VCS - ICL exchange</div>
          </div>
        </div>
        ...
        <div className="grid gap-4">
          {/* Column 1 */}
          <div className="gallery_card">
            <Image radius="lg"  className="image_content" src="/img/Gallery/bike_small.HEIC" alt="1" fill={true}/>
            <div className="overlay_text">My lovly motorrbike </div>
          </div>
          {/* Column 2 */}
          <div className="gallery_card">
            <Image radius="lg"  className="image_content" src="/img/Gallery/RBTL_big.jpg" alt="2" fill={true}/>
            <div className="overlay_text">Award for best poster and presentation in Blockkurs: Research Cycle in Genomics</div>
          </div>
          <div className="gallery_card">
            <Image radius="lg"  className="image_content" src="/img/Gallery/sunset_small.HEIC" alt="2" fill={true}/>
        ...
        <div className="grid gap-4">
          {/* Column 1 */}
          <div className="gallery_card">
            <Image radius="lg"  className="image_content" src="/img/Gallery/heart_small.jpg" alt="1" fill={true}/>
            <div className="overlay_text">Cy5 labled mRNA under confacal microscope</div>
          </div>
          {/* Column 2 */}
          <div className="gallery_card">
            <Image radius="lg"  className="image_content" src="/img/Gallery/paintball_small.jpg" alt="2" fill={true}/>
            <div className="overlay_text">Most sucessful event I coordinated, VCS plays paintball against VMP</div>
          </div>
          <div className="gallery_card">
            <Image radius="lg"  className="image_content" src="/img/Gallery/bib_big.HEIC" alt="2" fill={true}/>
